...
int batchpir_main(int argc, char *argv[]) {
    ...
    std::string filePath =
            std::string(std::getenv("TREEPIR_INPUT_DIR")) + "/list_TXs_" + std::to_string(tree_height) + "_" + std::to_string(2) +
            ".txt";
    ...
    std::string filename =
            std::string(std::getenv("TREEPIR_INPUT_DIR")) + "/subIndices/color_indices_" + std::to_string(tree_height) + "_" +
            std::to_string(2) +
            ".txt";
