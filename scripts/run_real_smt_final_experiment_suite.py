    ...
    rows = [
        ...
        },
        {
            **common,
            ...
            "max_bucket_log2": "",
            "notes": "PBC baseline over real SMT active proof records: 3 replicated copies over about 1.5m buckets.",
        },
        {
            **common,
...
def write_note(
    ...
    if sparse_rows:
        ...
        lines.append(
            f"| vs PBC baseline | width down {pct(width_reduction_pbc)}, max bucket down {pct(bucket_reduction_pbc)} | Generic batch coding does not exploit active interval/path structure. |"
        )
        lines.append(
