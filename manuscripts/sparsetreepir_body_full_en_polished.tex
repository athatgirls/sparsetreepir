...
\caption{\ActiveBalance{} as subtree recoloring. The refinement permutes colors inside a legal subtree, preserves the query width \(m\), and reduces the maximum color-subdatabase load in this toy instance.}
\label{fig:activebalance}
\end{figure}
