...
| vs Pruned TreePIR-h | width down 92.1%, max bucket down 60.7% | Pruning defaults but keeping the TreePIR-style h-color query universe leaves many empty color slots and unbalanced pruned stores. |
