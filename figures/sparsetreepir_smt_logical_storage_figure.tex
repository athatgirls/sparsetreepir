...
\node[font=\bfseries\small] at (10.2,0.45) {(b) Retrieval database and proof completion};
...
\node[font=\scriptsize,PrivateBlue!75!black,align=center] at ($(l3)+(0.0,0.62)$) {non-default\\sibling digest};
...
\node[note,anchor=north west,text width=2.9cm] (skel) at (6.7,-3.35) {The PIR database stores non-default proof digests. Empty subtrees are not materialized.};
